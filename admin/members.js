          ...
          <div>
            ...
            <div style="background: #ffffff; border: 1px solid #cbd5e1; border-radius: 6px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
              ...
              <table style="width: 100%; border-collapse: collapse; font-size: 11px; color: #334155;">
                <tr style="border-bottom: 1px solid #e2e8f0;">
                  <td style="padding: 7px 12px; border-right: 1px solid #e2e8f0; width: 32%; font-weight: 600; color: #0077b6;">Serial Number (SL):</td>
                  <td style="padding: 7px 12px; font-weight: bold; color: #0f172a;"># ${serialIndex}</td>
                </tr>
                <tr style="border-bottom: 1px solid #e2e8f0;">
            ...
            <div style="margin-top: 10px; background: #f8fafc; border: 1px dashed #cbd5e1; padding: 8px 12px; border-radius: 6px;">
              ...
              <ol style="margin: 0; padding-left: 14px; font-size: 9.5px; color: #475569; line-height: 1.35; text-align: justify;">
                <li>আমি সাক্ষ্য দিচ্ছি যে এই ফরমে প্রদত্ত সকল তথ্য সম্পূর্ণ সত্য। কোনো তথ্য অসত্য প্রমাণিত হলে সংগঠন আমার মেম্বারশিপ বাতিল করার অধিকার রাখে।</li>
