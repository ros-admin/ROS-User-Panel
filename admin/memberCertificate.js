                ...
                <div style="width: 842px; height: 595px; box-sizing: border-box; padding: 50px; position: relative;
                    ...
                    <div style="width: 100%; height: 100%; display: flex; flex-direction: column; justify-content: space-between; align-items: center; box-sizing: border-box; padding: 12px 15px; position: relative; z-index: 4;">
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center; gap: 8px; width: 100%;">
                            ...
                            <div style="background: #002b3d; border: 1.5px solid #FFD700; border-radius: 4px; padding: 4px 18px; display: flex; gap: 20px; justify-content: center; align-items: center; font-size: 11px; color: #ffffff;">
                                <div><span style="color: #94a3b8;">Registration No:</span> <strong style="color: #FFD700; font-size: 11px; margin-left: 2px; font-weight: 600;">${displayMemberId}</strong></div>
                                <div style="width: 1px; height: 10px; background: rgba(255,255,255,0.2);"></div>
                                <div><span style="color: #94a3b8;">Registration Date:</span> <strong style="color: #00C5FF; margin-left: 2px; font-weight: 500;">${regDateText}</strong></div>
                            </div>
