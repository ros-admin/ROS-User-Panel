...
function loadDownloadFormModule(contentRoot, currentMemberData) {
  ...
  // ১. ফায়ারবেস ডেটাবেজ স্ট্রাকচার অনুযায়ী সঠিক কি (Key) ম্যাপিং
  const m = currentMemberData || {};
  
  const mId = m.memberId || m.uid || '—';
  const regNo = m.registrationNo || mId;
  ...
  // ২. ড্যাশবোর্ডের মূল অফিশিয়াল থিম অনুযায়ী UI (কোনো প্রিভিউ স্ক্রিনে দেখাবে না)
    ...
    <div class="cyber-glass" style="padding: 25px; border-radius: 12px; margin-bottom: 25px; border-left: 4px solid var(--accent); background: var(--card-bg); backdrop-filter: blur(16px);">
      ...
      <div style="font-size: 14px; color: var(--text-light); line-height: 1.8; background: rgba(5, 17, 36, 0.7); padding: 20px; border-radius: 8px; margin-bottom: 20px; border: 1px solid rgba(0, 245, 255, 0.08);">
        <ol style="padding-left: 20px; margin: 0;">
          <li style="margin-bottom: 10px;"><strong>কর্তৃপক্ষের সর্বোচ্চ ক্ষমতা:</strong> সোসাইটির শৃঙ্খলা, ভাবমূর্তি ও আদর্শ পরিপন্থী কোনো কাজে লিপ্ত হলে, <span style="color: var(--secondary);">রাজশাহী অলিম্পিয়াড সোসাইটি (ROS)</span> authority যেকোনো সময় পূর্ব নোটিশ ছাড়াই সদস্যপদ সম্পূর্ণ বাতিল বা স্থগিত করার একক ক্ষমতা সংরক্ষণ করে।</li>
  ...
  // ৪. পিডিএফ জেনারেশন এবং কাটার সমস্যার স্থায়ী ফিক্স
  downloadBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      // A4 উইডথ অনুযায়ী নিখুঁত এইচটিএমএল স্ট্রাকচার
      const pdfBuffer = document.getElementById('pdfRenderBufferContainer');
      pdfBuffer.innerHTML = `
        <div id="actualTargetPaper" style="width: 535pt; background: #ffffff; color: #000000; font-family: 'Hind Siliguri', 'Arial', sans-serif; position: relative; box-sizing: border-box; overflow: hidden;">
          
          <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%) rotate(-30deg); opacity: 0.03; font-size: 38px; font-weight: bold; color: #000; text-align: center; width: 100%; pointer-events: none; white-space: nowrap;">
            RAJSHAHI OLIMPIAD SOCIETY
          </div>

          <div style="text-align: center; border-bottom: 2px solid #0077b6; padding-bottom: 8px; margin-bottom: 15px;">
          ...
          <div style="position: absolute; top: 105px; right: 5px; width: 85px; height: 100px; border: 1px dashed #0077b6; box-sizing: border-box; background: #fafafa; overflow:hidden;">
            ${photoHtml}
          </div>

          <div style="margin-bottom: 12px; font-size: 10.5px; line-height: 1.5;">
            <p style="margin: 2px 0;"><strong>সদস্য আইডি (ID):</strong> <span style="color: #0077b6; font-weight: bold; font-family:'Arial';">${mId}</span></p>
            <p style="margin: 2px 0;"><strong>নিবন্ধন নাম্বার:</strong> <span style="font-family:'Arial';">${regNo}</span></p>
          ...
          <h3 style="font-size: 11.5px; color: #0077b6; border-left: 3px solid #0077b6; padding-left: 6px; margin-bottom: 6px; padding-bottom: 1px;">১. সদস্যের বিস্তারিত তথ্যাবলী</h3>
          <table style="width: 100%; border-collapse: collapse; font-size: 10px; margin-bottom: 12px;">
            ...
            <tr>
              ...
              <td style="padding: 5px; border: 1px solid #cccccc; font-family:'Arial'; font-size: 9px; max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${email}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 5px; border: 1px solid #cccccc;" colspan="3">${gender}</td>
            </tr>
            <tr>
          ...
          <h3 style="font-size: 11.5px; color: #0077b6; border-left: 3px solid #0077b6; padding-left: 6px; margin-bottom: 5px;">২. সদস্যপদ বহাল থাকার শর্তাবলী ও ঘোষণা</h3>
          <div style="font-size: 9px; line-height: 1.4; color: #222; text-align: justify; background: #f9f9f9; padding: 8px; border: 1px solid #e0e0e0; border-radius: 4px; margin-bottom: 35px;">
          ...
          <div style="margin-top: 15px; display: flex; justify-content: space-between; font-size: 10px; padding: 0 5px;">
            ...
            <div style="text-align: center; width: 150px; position: relative;">
              <div style="font-family: 'Arial'; font-size: 10px; font-weight: bold; color: #2a9d8f; text-transform: uppercase; border: 2px dashed #2a9d8f; padding: 2px 6px; display: inline-block; margin-bottom: 4px; transform: rotate(-4deg); border-radius: 4px; background: #fff;">
                ✓ SIGNED VERIFIED
              </div>
          ...
          <div style="text-align: center; font-size: 8.5px; color: #e63946; font-weight: bold; background: #fff5f5; padding: 4px; border: 1px dashed #e63946; border-radius: 4px; margin-top: 25px; margin-bottom: 25px;">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; font-size: 8px; color: #666; border-top: 1px solid #eee; padding-top: 5px;">
      ...
      const options = {
        margin:       [30, 30, 30, 30], // 🎯 বামদিক এবং চারদিকের কাটা সমস্যা স্থায়ী সমাধান
      ...
      // মেমরি ক্লিন করা এবং বাটন রিস্টোর
